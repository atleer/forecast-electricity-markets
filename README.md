...
- No AI. Only use AI to help debug or as a teaching assistant (ask questions to check understanding). The code should be written and the problems solved by me for enhanced learning.
...
- [ ] Implement full test suite
  - Currently only tests preprocessing.
